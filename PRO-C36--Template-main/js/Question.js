class Question {
  ...
  display(){
    ...
    this.question.html("Question:- What is the approximate mass of the earth? " );
    // question.html("Question:- What starts and ends with the letter ‘E’, but has only one letter? " );

    this.question.position(150, 80);
    this.option1.html("1: 6 x 10^24 " );
    this.option1.position(150, 100);
    this.option2.html("2: 6 x 10^26 " );
    this.option2.position(150, 120);
    this.option3.html("3: 6 x 10^25 " );
    this.option3.position(150, 140);
    this.option4.html("4: 6 x 10^23 " );
